...
export const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className = "", children, ...props }, ref) => (
    <div
      ref={ref}
      className={`flex flex-col space-y-1 border-b border-[var(--border-color)] p-4 sm:p-5 ${className}`}
      {...props}
    >
      {children}
    </div>
...
export const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className = "", children, ...props }, ref) => (
    <h3
      ref={ref}
      className={`text-base font-bold leading-tight tracking-tight text-[var(--foreground)] sm:text-lg ${className}`}
      {...props}
    >
      {children}
    </h3>
...
export const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className = "", children, ...props }, ref) => (
    <p ref={ref} className={`text-sm leading-6 text-[var(--muted-foreground)] ${className}`} {...props}>
      {children}
    </p>
  ),
);
...
export const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className = "", children, ...props }, ref) => (
    <div
      ref={ref}
      className={`flex items-center border-t border-[var(--border-color)] p-4 sm:p-5 ${className}`}
      {...props}
    >
      {children}
    </div>
