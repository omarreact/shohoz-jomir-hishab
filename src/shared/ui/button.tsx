...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-[color-mix(in_srgb,var(--brand-gold)_30%,transparent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]",
  {
    variants: {
      variant: {
        ...
        dark: "bg-[var(--foreground)] text-white shadow-sm hover:bg-[var(--brand-ink-soft)]",
        destructive: "bg-red-600 text-white shadow-sm hover:bg-red-700",
        outline: "border border-[var(--border-color)] bg-white text-[var(--foreground)] shadow-sm hover:border-[color-mix(in_srgb,var(--brand-gold)_45%,var(--border-color))] hover:bg-[var(--brand-gold-faint)]",
        ...
        link: "text-[var(--brand-gold-text)] underline-offset-4 hover:underline",
      },
      size: {
