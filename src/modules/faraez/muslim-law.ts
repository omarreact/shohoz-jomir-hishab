...
export function calculateMuslimFaraez(input: HeirsInput, gender: DeceasedGender, assets: AssetsInput): HeirResult[] {
  ...
  if (input.mother > 0) {
    ...
    const reason = (hasChildOrAgnaticGrandChild || totalSiblings >= 2) ? "সন্তান বা একাধিক ভাই-বোন থাকায় মাতা ১/৬ অংশ পাবেন (সূরা আন-নিসা: ১১)।" : "মাতা ১/৩ অংশ পাবেন (সূরা আন-নিসা: ১১)।";
