...
describe("Faraez Awl", () => {
  it("proportionally reduces a fixed-share total above one", () => {
    ...
    expect(equals(adjusted[0].totalShare, rational(3n, 27n))).toBe(true);
    expect(equals(adjusted[1].totalShare, rational(4n, 27n))).toBe(true);
    expect(equals(adjusted[2].totalShare, rational(4n, 27n))).toBe(true);
    expect(equals(adjusted[3].totalShare, rational(16n, 27n))).toBe(true);
  });
