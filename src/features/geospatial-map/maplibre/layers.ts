...
export const VECTOR_LAYER_STYLES = {
  ...
  rsBoundaryLine: {
    ...
    type: "line",
    source: VECTOR_SOURCES.rsBoundary,
    paint: { "line-color": "#dc2626", "line-width": 1.6, "line-opacity": 0.9 },
  ...
  rsPlotLabels: {
    ...
    source: VECTOR_SOURCES.rsBoundary,
    layout: {
      "text-field": ["coalesce", ["get", "label"], ["get", "rs_plot_no"], ["concat", "RS-", ["to-string", ["get", "plot_no"]]], ""],
      "text-size": 11,
      "text-anchor": "center",
      "text-allow-overlap": false,
      "symbol-placement": "point",
    },
    paint: { "text-color": "#b91c1c", "text-halo-color": "#ffffff", "text-halo-width": 1.25, "text-halo-blur": 0.15 },
  ...
  msPlotLabels: {
    ...
    source: VECTOR_SOURCES.msBoundary,
    layout: {
      "text-field": ["coalesce", ["get", "label"], ["get", "ms_plot_no"], ["concat", "MS-", ["to-string", ["get", "plot_no"]]], ""],
      "text-size": 11,
      "text-anchor": "center",
      "text-allow-overlap": false,
      "symbol-placement": "point",
    },
    paint: { "text-color": "#7c3aed", "text-halo-color": "#ffffff", "text-halo-width": 1.25, "text-halo-blur": 0.15 },
  } satisfies SymbolLayerSpecification,
  selectedPlotFill: {
