...
function dagAreaLabel(row: {
  area?: string;
  shareArea?: string;
  totalArea?: string;
}): string {
  return row.area || row.shareArea || row.totalArea || "তথ্য পাওয়া যায়নি";
}
  ...
  return (
    ...
    >
      ...
      >
              ...
              <table className="w-full min-w-[22rem] border-collapse text-sm">
                <thead>
                  <tr className="border-b border-[var(--border-color)] text-left text-xs text-[var(--muted-foreground)]">
                    ...
                    <th className="px-2 py-2 font-semibold">জমির পরিমাণ</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    >
                      ...
                      <td
                        className={`px-2 py-2.5 ${
                          dag.area || dag.shareArea || dag.totalArea
        ...
        {!model.hasDagAreas && model.dags.length > 0 ? (
          <p className="mt-3 text-xs leading-6 text-[var(--muted-foreground)]">
            প্রতি দাগের আলাদা জমির পরিমাণ পাবলিক API-তে নেই বলে এখানে অনুমান করা হয়নি। মোট জমি আলাদাভাবে নিচে
            দেখানো হয়েছে।
          </p>
        ) : null}
