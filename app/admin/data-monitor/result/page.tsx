    ...
    return (
      <div className="p-4">
        <div className="alert alert-warning">
          No APIs selected. Please go back and select APIs to test.
        </div>
        <Link href="/admin/data-monitor" className="btn btn-outline-secondary">
          Go Back
        </Link>
      </div>
    );
      ...
      <div className="d-flex align-items-center justify-content-between mb-4">
        <div>
          <Link
            ...
            className="btn btn-sm btn-light text-secondary rounded-pill mb-2 d-inline-flex align-items-center gap-1"
          >
        ...
        {loading && (
          <div className="d-flex align-items-center gap-2 text-primary fw-bold">
            <span className="spinner-border spinner-border-sm"></span> Fetching
            APIs...
          </div>
        )}
      </div>
        ...
        {loading ? (
          <div className="text-center py-5">
            ...
            <p className="text-muted fw-bold">
              Executing {apisParam?.split(",").length || 0} API requests in
              parallel...
            </p>
          </div>
        ) : (
            ...
            >
              <div className="card-header bg-white border-bottom p-3 d-flex flex-wrap align-items-center justify-content-between gap-3">
                ...
                <div className="d-flex gap-2 align-items-center">
                  ...
                  <span
                    className={`badge rounded-pill px-3 py-2 ${res.status === 200 ? "bg-success" : "bg-danger"}`}
                  >
                    Status: {res.status}
                  </span>
                </div>
